...
function Chat() {
  ...
  const handleSubmit = async (userInput) => {
    ...
    try {
      const res = await axios.post(`${BACKEND_URL}/api/chat/send`, { message: userInput });
      let aiMessage = { type: 'ai', text: res.data.benny_message.message_text  || "Sorry, something went wrong." };
