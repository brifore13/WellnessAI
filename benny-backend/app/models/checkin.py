...
class DailyCheckin(Base):
    ...
    # Timestamp
    log_date = Column(DateTime(timezone=False), nullable=False, default=datetime.now(), index=True)
    ...
    updated_at = Column(DateTime(timezone=False), nullable=False, default=datetime.now())
